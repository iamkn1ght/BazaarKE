    ...
    return (
        <header className="mb-8 border-b">
            <div className="flex items-center justify-between mx-auto max-w-2xl px-4 sm:px-6 lg:max-w-7xl">
                <Link href='/'>
                <h1 className="text-2xl md:text-4xl font-bold">Unique<span className="text-primary">Accessories</span></h1>
                </Link>
                ...
                <div className="flex divide-x border-r sm:border-l">
                    <Button className="flex flex-col gap-y-1.5 h-12 w-12 sm:h-20 sm:w-20 md:w-24 rounded-none" variant={"outline"} onClick={() => handleCartClick()}>
                        <ShoppingBag />
