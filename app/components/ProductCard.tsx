...
export default function ProductCard({
  ...
  return (
    <Link href={`/product/${product.slug}`} className="group block reveal-up">
      <div className="relative aspect-[4/5] w-full overflow-hidden rounded-xl border border-border bg-muted shadow-sm transition-shadow duration-300 ease-soft group-hover:shadow-md">
        <Image
          ...
          priority={priority}
          className="object-cover transition-transform duration-700 ease-soft motion-safe:group-hover:scale-105"
        />
      </div>
